...
ax.set_title("Animated Phasor Plot for Two Slits")
dtheta = 0.008
...
def animate(i):
    ...
    y2.append((ctot*ctot+stot*stot)/2)
#    x2[i+2]=theta/3
#    y2[i+2]=np.sqrt(ctot*ctot+stot*stot)-3
    line1.set_xdata([0, c1, c1+c2, ctot])
    line1.set_ydata([0, s1, s1+s2, stot])
